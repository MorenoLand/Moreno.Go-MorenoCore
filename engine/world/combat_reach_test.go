...
func TestCreatureCombatReachUsesModelInfo(t *testing.T) {
	...
	for _, statement := range []string{
		...
		"CREATE TABLE creature_model_info (DisplayID INTEGER PRIMARY KEY, BoundingRadius REAL, CombatReach REAL)",
		"INSERT INTO creature_template VALUES (68, 20, 1, 0, 2000, 1, 1, 1, 0, 0, 9001)",
		"INSERT INTO creature_model_info VALUES (9001, 0.8, 4.25)",
	} {
	...
	if stats.CombatReach != 4.25 || stats.BoundingRadius != 0.8 {
		t.Fatalf("model reach=%v radius=%v", stats.CombatReach, stats.BoundingRadius)
	}
