...
| --- | ---: | ---: | ---: |
| Server source files / lines | 1410 / 710273 | 298 / 112709 | — |
...
| Test source files / lines | 9 / 1390 | 154 / 40249 | — |
...
- `handleKeepAlive (server.go:2875)`
- `handlePlayerLogout (characters.go:1751)`
