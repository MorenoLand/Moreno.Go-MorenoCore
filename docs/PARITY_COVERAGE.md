...
| --- | ---: | ---: | ---: |
| Server source files / lines | 1410 / 710273 | 285 / 109192 | — |
...
| Test source files / lines | 9 / 1390 | 145 / 38761 | — |
...
- `handleKeepAlive (server.go:2860)`
- `handlePlayerLogout (characters.go:1686)`
...
- source emits a dummy MMAP header instead of navmesh tiles

### `tools/mpq`

- source rejects required MPQ compression methods
