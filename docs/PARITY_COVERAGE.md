...
| --- | ---: | ---: | ---: |
| Server source files / lines | 1410 / 710273 | 285 / 109444 | — |
...
| Test source files / lines | 9 / 1390 | 145 / 38867 | — |
...
- `handleKeepAlive (server.go:2863)`
- `handlePlayerLogout (characters.go:1688)`
